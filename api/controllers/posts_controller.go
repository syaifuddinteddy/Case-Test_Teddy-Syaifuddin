...
func (server *Server) UploadImages(w http.ResponseWriter, r *http.Request) {
	if r.Method != "POST" {
	...
	fileLocation := filepath.Join(dir, "download", filename)
...
func (server *Server) ShowImages(w http.ResponseWriter, r *http.Request) {
	if r.Method != "POST" {
		http.Error(w, "", http.StatusBadRequest)
		return
	}
